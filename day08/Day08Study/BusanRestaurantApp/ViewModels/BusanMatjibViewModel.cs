...
namespace BusanRestaurantApp.ViewModels
{
    public partial class BusanMatjibViewModel : ObservableObject
    {
        ...
        public async Task MatjibItemDoubleClick()
        {
            ...
            viewModel.SelectedMatjibItem = SelectedMatjibItem; // 메인창에 있는 선택아이템을 구글맵쪽으로 그대로 전달
        ...
        private async Task GetDataFromOpenApi()
        {
            ...
            string myServiceKey = "K%2FwOnvrW3DX1iKxrVmBajkWCUNO1RgqCgX33rmDg3UlgdQRrY9G9d386eQ4eAEIyYLFjT64tDMqQxUtAFtO1Zw%3D%3D";
            //K%2FwOnvrW3DX1iKxrVmBajkWCUNO1RgqCgX33rmDg3UlgdQRrY9G9d386eQ4eAEIyYLFjT64tDMqQxUtAFtO1Zw%3D%3D
                ...
                if (status == "00")
                {
                    ...
                    foreach(var subitem in jsonArray)
                    {
                        ...
                        busanItems.Add(new BusanItem
                        {
                            ...
                            Cntct_Tel = Convert.ToString(subitem["CNTCT_TEL"]).Replace("\n", ""),
