...
2. NuGet 패키지 사용할 기본 라이브러리 설치
    - CommunityToolkit.Mvvm
    - MahApps.Metro / MahApp.Metro.IconPacks
    - MySql.Data
    - NLog
...
<img src="./image/wpf0024.png" width="600">
...
5. VS Code에서 [MqttPub.py](./day08/Pythons/MqttPub.py) 파일 생성
    ...
    <img src="./image/wpf0025.gif" width="550">
...
6. MqttPub.py와 Publish된 IoT데이터 WPF에서 Subscribe 예제
    ...
    <img src="./image/wpf0026.gif" width="650">
